...
* Developing primary screens of the application.
...
__Darshan (Back-end Developer for *Nearby Events* API)__:
...
* [GitHub Issues](https://github.com/csc301-fall-2016/project-team-16/issues) will be used for formally defining tasks and assigning them to team members.
 ...
 * Making UI elements (such as buttons and maps) interactive.
 ...
 * Learning to operate basic video editing software.
